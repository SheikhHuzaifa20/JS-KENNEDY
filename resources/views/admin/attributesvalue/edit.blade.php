...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block">Attributes Value Content</h3>
        <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active">Home</li>
                    <li class="breadcrumb-item active">Attributes Value </li>
                    <li class="breadcrumb-item active">Edit Attributes Value </li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            {!! Form::model($attributes, [
                                ...
                                'url' => ['/admin/attributes-value', $attributes->id],
                                'files' => true
                            ]) !!}

                            @include ('admin.attributesvalue.form', ['submitButtonText' => 'Update'])
