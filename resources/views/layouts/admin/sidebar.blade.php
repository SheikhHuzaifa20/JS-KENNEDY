<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item">
                <a href="javascript:;"><img src="{{asset("asset/images/author-admin-book.png")}}" alt=""><span class="menu-title"
                        data-i18n="Dashboard">Author</span></a>
                <ul class="menu-content">
                    {{-- <li
            ...
            <li class="nav-item {{ request()->is('admin/poll') || request()->is('admin/poll/*') ? 'active' : '' }}">
                <a href="{{ url('admin/poll') }}"><i class="la la-check-square"></i>
